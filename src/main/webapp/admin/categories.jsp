<%-- 
    Document   : categories
    Created on : Jan 7, 2026, 9:25:36 AM
    Author     : hengk
--%>
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 p-4 p-md-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <button class="btn btn-primary-custom shadow-sm"><i class="fas fa-plus me-2"></i> Add Category</button>
            </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <button class="btn btn-sm btn-outline-danger" onclick="if(confirm('Delete category?')) this.closest('tr').remove()"><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td class="fw-bold">Fiction</td>
                            <td>320</td>
                            <td class="text-end">
                                <button class="btn btn-sm btn-outline-primary me-1"><i class="fas fa-pen"></i></button>
                                <button class="btn btn-sm btn-outline-danger" onclick="if(confirm('Delete category?')) this.closest('tr').remove()"><i class="fas fa-trash"></i></button>
